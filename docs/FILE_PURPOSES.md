...
本步只改 README、媒体与交接文档，无核心代码，因此无核心代码注释需求。

| 变更 | 文件 | 作用 | 下游影响 |
|---|---|---|---|
| 新建 | `docs/media/core_loop_architecture.png` | 保存自然语言输入、RAG、任务规划、确定性工具执行、观测验证、重规划与失败返回关系的核心闭环架构图。 | GitHub README 使用稳定的仓库内相对路径展示。 |
